...
<style>
  ...
  <div class="row" style="margin: 28px 28px 30px 28px;">
     <div class="col-md-7 SingleImage" style="background: #E8EAED;">
                ...
                <a href="{{ url('/collection/image/'.$image->category_id.'/'.$previousID.'/'.$image->sub_category_id) }}"
        ...
        <div class="expand-img" role="button" >
           ...
           {{-- Next Page Link --}}
            ...
            <a href="{{ url('/collection/image/'.$image->category_id.'/'.$nextID.'/'.$image->sub_category_id) }}"
